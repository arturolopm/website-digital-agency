  ...
  return (<div>
    <div className=" p-4   mx-auto relative z-10  w-full pt-20 md:pt-32">
      <div className="text-4xl md:pb-8 md:text-7xl text-center bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-sky-200 bg-opacity-50">
        Creación de anuncios <br />
      </div>

      <p className="mt-4 text-lg font-normal  text-neutral-300 max-w-lg text-center mx-auto">
        Diseño de anuncios pensados para vender. Dale un impulso a tu negocio con facebook ads. Nosotros hacemos los anuncios, tu te encargas de cerrar la venta.
      </p>
